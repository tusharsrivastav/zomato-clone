...
const ExlporeCard = ({ restaurant }) => {
  ...
  const goldOff = restaurant?.goldOff?.text
  ...
  return <div className='explore-card cur-po'>
    ...
    <div className='explore-card-cover'>
      <img src={coverImg} alt={name} className='explore-card-img' ></img>
    ...
    <div className='delivery-time res-row'>{deliveryTime}</div>

  </div>
}

export default ExlporeCard